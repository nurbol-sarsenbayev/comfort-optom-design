$(function() {
    ...
    // $(".carousel-certificate .link").click(function(e) {
    //     e.preventDefault();
    //     e.stopPropagation();
    //     return false;
    // });
    ...
    //     if([480, 768, 992, 1200].indexOf(w) >= 0) {
    //         // carouselTeam.destroy();
    //         // carouselTeam.owlCarousel(teamSettings);
    //     }
    //     console.log('resized', $wnd.outerWidth());
    // })
});
